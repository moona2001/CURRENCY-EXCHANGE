...
//                Close_MainActivity();
    ...
    public String getConversionRate(String convert_from_value, String convert_to_value, Double edit_amount_to_convert_value) {
        ...
        String url = "https://api.exchangeratesapi.net/v1/exchange-rates/convert?access_key=QfN0l5RAse87Dpma&from="+convert_from_value+"&to="+convert_to_value+"&amount="+ edit_amount_to_convert_value+"";
        ...
        StringRequest stringrequest = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    Double conversion_value = round(((Double) jsonobject.get("result")), 2);
                    // conversion_value = "" + round((conversion_rate_value * edit_amount_to_convert_value), 2);
                    conversion_rate.setText(conversion_value.toString());
